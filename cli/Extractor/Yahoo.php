...
/**
 * This class is responsible for extracting the features from the yahoo raw data that we got through the scraping process.
 * Each method in this class extracts a single feature from the raw data and returns this feature. The method called 'analyze'
 * will return an array with all the features that were extracted from the yahoo.
 */
