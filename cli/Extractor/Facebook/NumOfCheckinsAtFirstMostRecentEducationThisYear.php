...
class NumOfCheckinsAtFirstMostRecentEducationThisYear extends AbstractExtractor {
    /**
     * {@inheritdoc}
     */
    public function execute() {
        ...
        if (! empty($locations)) {
            foreach ($locations as $location) {
                ...
                if ($location['place']['id'] !== $education[0]['id']) {
                    continue;
                }
        ...
        if (! empty($links)) {
            foreach ($links as $link) {
                ...
                if ($link['place']['id'] !== $education[0]['id']) {
                    continue;
                }
        ...
        if (! empty($photos)) {
            foreach ($photos as $photo) {
                ...
                if ($photo['place']['id'] !== $education[0]['id']) {
                    continue;
                }
        ...
        if (! empty($posts)) {
            foreach ($posts as $post) {
                ...
                if ($post['place']['id'] !== $education[0]['id']) {
                    continue;
                }
        ...
        if (! empty($statuses)) {
            foreach ($statuses as $status) {
                ...
                if ($status['place']['id'] !== $education[0]['id']) {
                    continue;
                }
        ...
        if (! empty($tagged)) {
            foreach ($tagged as $tagged) {
                ...
                if ($tagged['place']['id'] !== $education[0]['id']) {
                    continue;
                }
